    ...
    <section class="about-section section-padding" id="section_2">
        <div class="container">
            <div class="row">
                ...
                <?php
                include_once 'partials/team.php';
                ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="section-bg-image-block">
                        ...
                        <form action="#" method="index.php" class="custom-form mt-lg-4 mt-2" role="form">
                            <div class="input-group input-group-lg">
                                ...
                                <button type="submit" class="form-control">Prihlásiť sa</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-3 mb-lg-0">
                    ...
                    <?php
                    include_once 'partials/membership_fee.php';
                    ?>

                    <div class="col-lg-5 col-12 mx-auto">
                        <h4 class="mb-4 pb-lg-2">Pridaj sa k nám!</h4>
                        <form action="#" method="index.php" class="custom-form membership-form shadow-lg" role="form">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-floating">
                                    ...
                                    <label for="floatingInput">Meno a priezvisko</label>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-12">
                                ...
                                <button type="submit" class="form-control">Odoslať formulár</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="contact-info mt-5">
                        <div class="contact-info-item">
                            <div class="contact-info-body">
                                <strong>Bratislava, Slovensko</strong>
